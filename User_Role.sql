...
GRANT SELECT ON [Member Transaction Details View] TO [Member], [Store Clerk]
...
GRANT ALTER ON [Equipment] TO [Database Administrator];
GRANT ALTER ON [Category] TO [Database Administrator];
GRANT ALTER ON [Country] TO [Database Administrator];
